...
public class CardSource {
    ...
    public void InitializeCards() {
        ...
        Card newCard = new Card("Dark Pact", "Draw 2 Cards", 5, effects);
        ...
        newCard = new Card("Not-so-dark pact", "Draw 1 Card", 2, effects);
        ...
        newCard = new Card("Got Enough Draw?", "Draw 3 Cards", 5, effects);
        ...
        newCard = new Card("Let's summon Mom, Edward", "Summon a zombie", 10, effects);
        ...
        newCard = new Card("moar portals", "increase summon slots by 2", 7, effects);
        ...
        newCard = new Card("too many holes", "reduce summon slots by 1", 7, effects);
        ...
        newCard = new Card("Mr. Bones' Wild Ride", "Summon a skeleton", 5, effects);
        ...
        newCard = new Card("Spooky time", "Summon a spirit", 6, effects);
        ...
        newCard = new Card("Damage test", "Deal 5 damage to 1 or 2 targets", 3, effects);
