...
public class ChangeTargetHealth : TargetableDynamicEffect {
    public ChangeTargetHealth(int effectCount, List<Target> validTargets, string targetingDialogue, int minTargets, int maxTargets)
