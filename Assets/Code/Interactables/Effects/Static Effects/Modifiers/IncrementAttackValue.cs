...
public class IncrementAttackValue : Modifier {
    // Modifier for incrementing character attack
    ...
    public IncrementAttackValue(int effectCount, List<Trigger> triggers, int incrementTimes = -1) : base(effectCount, triggers, 0) {
